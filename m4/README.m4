...
WHAT IS THE EXTREMUM PROJECT ?

The Extremum [1] project explores various curvature (local extrema) cut functions.  Its purpose is
to help understand various curvature algorithms and how they are implemented as well as being a
library to handle curvature and local extrema functions.

[1] http://en.wikipedia.org/wiki/Singular_point_of_a_curvehttp://en.wikipedia.org/wiki/Singular_point_of_a_curve
